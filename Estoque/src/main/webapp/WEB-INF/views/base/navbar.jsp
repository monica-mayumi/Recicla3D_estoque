		...
		<div>
			<div class=" nav-wrapper grey darken-3">
				...
				<ul class="right hide-on-med-and-down">
					<li><a href="sobre"><i class="material-icons right">people_outline</i>Sobre</a></li> 
					<li><a href="contato"><i class="material-icons right">contact_mail</i>Fale Conosco</a></li>
