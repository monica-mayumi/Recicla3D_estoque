		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="input-field col s3 offset-s3">
					<a class="btn-floating btn-large waves-effect waves-light cyan darken-4 right" title="novo" href="${s:mvcUrl('novoRecebimentoUrl').build()}" >
								...
								<c:forEach items="${listaPaginada.content}" var="registro" >
									<tr>
										...
										<td class="center-align">
											<a class="btn-small indigo darken-2" title="detalhes" href="${s:mvcUrl('detalharRecebimentoUrl').arg(0, registro.id).build()}"><i class="material-icons">more_horiz</i></a>
											<button class="btn-small red darken-4 modal-excluir" title="estornar" type="button" data-target="modalExcluir" 
